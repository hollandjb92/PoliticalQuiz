...
"<div class='collapse' id='collapseExample1'>" +
  "<div class='card card-body'>" +
     "<p> <strong>Question 1: </strong> Some states have decriminalized marijuana. Some candidates fully support decriminalizing marijuana on a federal level because they believe these drug laws do more harm than good. Others want to leave it up to the states to decide. The federal government usually doesn’t enforce marijuana prohibition laws in states that have legalized marijuana. It’s more of an informal rule but it could easily be overturned by whoever is in charge. </p>" +
        "<p> <strong>Question 2: </strong> Nearly all Democrats support universal background checks and closing any loopholes in the system. Currently private dealers at gun shows do not have to run background checks on potential buyers (this is commonly known as the gun show loophole). Also, if the FBI doesn’t complete a buyers background check within three days, a licensed gun seller can still sell the gun. </p>" +
        "<p> <strong>Question 3: </strong> Many Democrats are speaking out against the death penalty. Several states (and Washington D.C.) have outlawed the death penalty. Those who oppose it say it’s inhumane and that there have been many people who were wrongly executed. Others would keep it but only for extreme cases (such as terrorism). Donald Trump supports the death penalty and has even talked about using it more often.</p>" +
     "</div>" +
"</div>" +
  ...
  $(document).on("click", "#criminalJustice", function () {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample2'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 4: </strong>The Tax Cuts and Jobs Act from 2017 cut corporate taxes. It is widely unpopular among Democrats, who say it only benefits corporations and the wealthy.</p>" +
              "<p> <strong>Question 5: </strong>The federal minimum wage is currently set at $7.25 (it’s been this way since 2009). States may have different minimum wage laws. Most Democrats and some Republicans think the minimum wage should go up (but they don’t always agree on the exact dollar amount). Many people in Donald Trump’s cabinet oppose raising the minimum wage.</p>" +
              "<p> <strong>Question 6: </strong>Raising taxes on the wealthy is becoming an increasingly popular position. Others want to give more tax credits to middle and low income Americans. </p>" +
           "</div>" +
      "</div>" +
  ...
  $(document).on("click", "#taxWage", function (event) {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample3'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 7: </strong>All of the 2020 Democrats consider themselves pro-choice. Some want the federal government to step in to stop states from passing restrictive abortion bans and allow federal funds to pay for them. Others support abortion rights but are unclear on the specifics. Donald Trump has shifted his position from pro-choice to pro-life over the years.</p>" +
              "<p> <strong>Question 8: </strong> All 2020 Democrats support universal health care. Some candidates would like to transition to a Medicare for all system that eliminates private health insurance. Others support having a government run healthcare program that also allows people to keep existing private healthcare plans if they choose to. Others say Medicare for all is too expensive and unrealistic but would expand the ACA (Affordable Health Care Act or Obamacare) to cover more people.</p>" +
              "<p> <strong>Question 9: </strong> Americans often pay more for prescription drugs than other developed nations. In other countries, governments negotiate the price of drugs to keep the costs low. Different candidates have different ideas for controlling rising drug prices. These include using Medicare to negotiate drug prices, allowing the importation of drugs, encouraging production of cheaper generic drugs and imposing taxes on drug companies that raise the price of drugs.</p>" +
           "</div>" +
      "</div>" +
  ...
  $(document).on("click", "#healthcare", function (event) {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample4'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 10: </strong> Tuition free college is becoming more and more popular as student debt rises. Some candidates support free college, while others support free college for the first two years, free community college, free vocational training or making education free for low-income families. Others support increasing financial aid for students so students don’t have to go into debt.</p>" +
              "<p> <strong>Question 11: </strong> Some candidates have bold plans to cancel all or some student debts. Others want to fix current debt relief programs such as cancelling student debt for people who work in public service or forgiving student debt for teachers. Most 2020 Democratic candidates want to lower monthly payments for borrowers and reduce interest rates on federal loans. </p>" +
              "<p> <strong>Question 12: </strong>Since 2018, teachers in various states have begun striking to protest low pay and poor working conditions. Teachers often make less than other professionals with similar education and experience. </p>" +
           "</div>" +
      "</div>" +
  ...
  $(document).on("click", "#education", function (event) {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample5'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 13: </strong> Earlier this year freshman Representative Alexandria Ocasio-Cortez and Senator Ed Markey introduced an ambitious plan to fight climate change. This nonbinding resolution calls for dramatically reducing carbon emissions, investing in clean energy and transportation and creating jobs in the clean energy field. Many Democrats support it but others think it is too ambitious or disagree with some of the specifics. They have their own plans to fight climate change. Donald Trump has stated that he doesn’t believe in climate change.</p>" +
              "<p> <strong>Question 14: </strong> The Paris Agreement is an international accord adopted by most countries in 2015. Each country commits to reducing greenhouse gas emissions in order to prevent global temperatures from rising above 2 degrees Celsius. Each country sets their own goals. Donald Trump announced in 2017 that he plans to withdraw. The U.S. can’t formally withdraw until 2020 so a new leader could re-join when they take office.</p>" +
              "<p> <strong>Question 15: </strong> Nuclear power creates a lot of electricity without the greenhouse gas emissions of coal or natural gas. But the waste created from nuclear power plants can be dangerous. This has become an even bigger concern after the infamous 2011 Fukushima meltdown in Japan. </p>" +
           "</div>" +
      "</div>" +
  ...
  $(document).on("click", "#climate", function (event) {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample6'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 16: </strong>It’s currently a crime to cross the border with an inspection by an immigration officer. Some candidates have proposed making it a civil offense rather than a crime. Others want to keep the statue in place but still reform immigration laws.</p>" +
              "<p> <strong>Question 17: </strong> President Obama created DACA in 2012. This program allows undocumented immigrants brought to the country as children (known as “Dreamers”) to live and work here without the threat of deportation. President Trump has been trying since 2017 to phase out the program but the decision has been temporarily blocked by federal courts. Members of Congress have (unsuccessfully) tried for years to provide a path to citizenship for Dreamers.</p>" +
              "<p> <strong>Question 18: </strong> “The Wall” was one of Donald Trump’s signature campaign promises. Most Democrats oppose spending billions to build the wall. Some Democrats even want to tear down portions of the wall. Others are considering supporting border wall funding as part of immigration reform bills.</p>" +
           "</div>" +
      "</div>" +
  ...
  $(document).on("click", "#immigration", function (event) {
    ...
    $("#questionsDiv").append(
      ...
      "<div class='collapse' id='collapseExample6'>" +
        "<div class='card card-body'>" +
           "<p> <strong>Question 19: </strong> Age is a concern for some of the candidates. Donald Trump is currently the oldest U.S. President at 73. If elected, Bernie Sanders would become the oldest president at 79. The 2020 race also has some younger candidates. If elected Pete Buttigieg would become the youngest president ever at 38.</p>" +
           "</div>" +
      "</div>" +
